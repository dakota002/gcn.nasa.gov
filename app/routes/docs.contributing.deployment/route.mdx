...
computer, first [sign in to the AWS SDK on your computer](https://confluence.sciencecloud.nasa.gov/spaces/SCKB/pages/32178214/Science+Cloud+AWS+Account+Login+Procedure).
...
npm run build
AWS_SDK_LOAD_CONFIG=true npx arc deploy --prune --production --no-hydrate
```
